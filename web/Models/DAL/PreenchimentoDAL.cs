    ...
    public class PreenchimentoDAL
    {
        ...
        public static IList<object> Get(Int32 ID_FORMULARIO, string[] colunasForm, string dataInicialFiltro, string dataFinalFiltro, string statusFormFiltro, int start, int pageSize, ref int totRegistros, string textoFiltro, ref int totRegistrosFiltro, string sortColumn, string sortColumnDir, string userNameCriador, string statusFiltroUsuarioLogado, string[] camposDinamicosFiltro, string idBuscaPreenchimento)
        {
            ...
            try
            {
                ...
                StringBuilder colunasSelect = new StringBuilder("TB_DINAMICA.ID,TB_DINAMICA.ID_STATUS_ATUAL,TB_DINAMICA.NOME_RESPONSAVEL,TB_DINAMICA.[Criação],TB_DINAMICA.[Identificador],TB_DINAMICA.[Status],");
                StringBuilder colunasFiltro = new StringBuilder();
                int totColunasFixas = 6;//ID, ID_STATUS_ATUAL, NOME_RESPONSAVEL, DATA_CRIACAO, IDENTIFICADOR e NOME_STATUS_ATUAL
                if (colunasForm.Length > totColunasFixas)
                {
                    ...
                    (
                        SELECT ID_PREENCHIMENTO_FORMULARIO AS ID,ID_STATUS_ATUAL,NOME_RESPONSAVEL,[Criação],[Identificador],[Status],").Append(colunasFormConca).Append(@" from 
				        (
				        SELECT 
				        ...
				        GROUP BY ID_PREENCHIMENTO_FORMULARIO, ID_STATUS_ATUAL, NOME_RESPONSAVEL, [Criação], [Identificador], [Status]
                    ) AS TB_DINAMICA
                    ");
                    #endregion
        ...
        public static IList<object> GetParaExcelGenerica(int[] formularios, string dataInicialFiltro, string dataFinalFiltro, string idBuscaPreenchimento, string gruposFiltroUsuarioLogado)
        {
            ...
            try
            {
                ...
                StringBuilder colunasFormConca = new StringBuilder();
                StringBuilder colunasSelect = new StringBuilder("TB_DINAMICA.ID_FORMULARIO,TB_DINAMICA.ID,TB_DINAMICA.ID_STATUS_ATUAL,TB_DINAMICA.NOME_RESPONSAVEL,TB_DINAMICA.[Formulário],TB_DINAMICA.[Criação],TB_DINAMICA.[Identificador],TB_DINAMICA.[Status]");
                ...
                StringBuilder tabelaDinamica = new StringBuilder(@"
                (
                    SELECT ID_FORMULARIO, [Formulário], ID_PREENCHIMENTO_FORMULARIO AS ID,ID_STATUS_ATUAL,NOME_RESPONSAVEL,[Criação],[Identificador],[Status] from 
				    (
				    SELECT 
				    ...
				    GROUP BY ID_FORMULARIO, [Formulário], ID_PREENCHIMENTO_FORMULARIO, ID_STATUS_ATUAL, NOME_RESPONSAVEL, [Criação], [Identificador], [Status]
                ) AS TB_DINAMICA
                ");
                #endregion
                ...
                int indiceNumeroLinha = 8;
                string[] colunasForm = "ID_FORMULARIO;ID;ID_STATUS_ATUAL;NOME_RESPONSAVEL;Formulário;Criação;Identificador;Status".Split(';');
                while (rd.Read())
                {
        ...
        public static IList<object> GetBuscaAvancadaGenerica(int[] formularios, string dataInicialFiltro, string dataFinalFiltro, int start, int pageSize, ref int totRegistros, string textoFiltro, ref int totRegistrosFiltro, string sortColumn, string sortColumnDir, string idBuscaPreenchimento, string gruposFiltroUsuarioLogado)
        {
            ...
            try
            {
                ...
                StringBuilder colunasSelect = new StringBuilder("TB_DINAMICA.ID_FORMULARIO,TB_DINAMICA.[Formulário],TB_DINAMICA.ID,TB_DINAMICA.ID_STATUS_ATUAL,TB_DINAMICA.NOME_RESPONSAVEL,TB_DINAMICA.[Criação],TB_DINAMICA.[Identificador],TB_DINAMICA.[Status],TB_DINAMICA.[Responsável],");
                StringBuilder colunasFiltro = new StringBuilder();
                ...
                StringBuilder tabelaDinamica = new StringBuilder(@"
                (
                    SELECT ID_FORMULARIO, [Formulário], ID_PREENCHIMENTO_FORMULARIO AS ID,ID_STATUS_ATUAL,NOME_RESPONSAVEL,[Criação],[Identificador],[Status],[Responsável] 
		            ...
		            GROUP BY ID_FORMULARIO, [Formulário], ID_PREENCHIMENTO_FORMULARIO, ID_STATUS_ATUAL, NOME_RESPONSAVEL, [Criação], [Identificador], [Status], [Responsável]
                ) AS TB_DINAMICA
                ");
                #endregion
                ...
                string[] colunasForm = "ID_FORMULARIO;Formulário;ID;ID_STATUS_ATUAL;NOME_RESPONSAVEL;Criação;Identificador;Status;Responsável".Split(';');
                while (rd.Read())
                {
                    objs.Add(MontarRegistro(rd, colunasForm, 0, indiceNumeroLinha));
                }
        ...
        public static int? Update(Preenchimento obj, Tramitacao tro, Usuario usuarioLogado)
        {
            ...
            using (SqlConnection con = new SqlConnection(Util.CONNECTION_STRING))
            {
                ...
                try
                {
                    ...
                    comm.Parameters.Add(new SqlParameter("OBSERVACAO", tro.OBSERVACAO));
                    comm.Parameters.Add(new SqlParameter("ID_PREENCHIMENTO_FORMULARIO", obj.ID));
                    comm.Parameters.Add(new SqlParameter("ID_STATUS_ORIGEM", tro.statusOrigem.ID));
                    comm.Parameters.Add(new SqlParameter("ID_STATUS_DESTINO", tro.statusDestino.ID));
