...
function exibirDetalhes(id, idStatusAtual, idBusca, dataHora, nomeStatusAtual) {
...
function carregarFormCadastro(id, idStatusAtual, idBusca, dataHora, nomeStatusAtual) {
    $('#btnSalvarContinuar').css('display', 'none');
...
function carregarFormClonagem(id, idStatusAtual, idBusca, dataHora, nomeStatusAtual) {
...
function colunasTabelaAlteracao(objetoTabela) {
    return '\'' + objetoTabela.ID + '\', \'' + objetoTabela.ID_STATUS_ATUAL + '\', \'' + objetoTabela['Identificador'] + '\', \'' + objetoTabela['Criação'] + '\', \'' + objetoTabela['Status'] + '\'';
}
//Setar para habilitar o botao de alteracao
