...
namespace web.Controllers
{
    public class PreenchimentosController : SegurancaController
    {
        ...
        public JsonResult GetColunasDinamicas(int ID_FORMULARIO, char somenteAtivos)
        {
            ...
            {
                string[] colunasFixas = "ID;ID_STATUS_ATUAL;NOME_RESPONSAVEL;Criação;Identificador;Status".Split(';');
                string[] colunasFixasExibidasGrid = "Criação;Identificador;Status".Split(';');
        ...
        public FileResult ExportarExcel(string dados, string nomeTabela)
        {
            ...
            return DownloadExcel(auxDados, string.Format("{0}.xls", nomeTabela));
        }
